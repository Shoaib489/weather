...
const Temperature = () => {
  ...
  const getBackground = (description) => {
    ...
    if (description?.includes('thunderstorm')) return '/images/clearSky.jpg';
    if (description?.includes('snow')) return '/images/clearSky.jpg';
    ...
    return "https://pics.freeartbackgrounds.com/midle/Rural_Meadow_Landscape_Background-900.jpg";
  };
